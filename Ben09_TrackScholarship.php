...
/* 4. تحديد حالة الأزرار بناءً على البيانات المسترجعة */
...
if ($request) {
    ...
    if ($dbStatus === "مقبول") {
        ...
        //  زر العقد يتفعل فقط إذا وُجد سجل عقد
        if (!empty($request['contract_id'])) {
            $contractEnabled = true;
        }
        
        //  زر التقارير يتفعل فقط إذا كانت حالة العقد 'تمت الموافقة'
