...
<head>
<meta charset="UTF-8">
<title>تقييمات المستفيدين</title>
<link href="https://fonts.googleapis.com/css2?family=Noto+Kufi+Arabic:wght@400;500;600;700&display=swap" rel="stylesheet">
<link rel="stylesheet" href="CSS01Layout.css?v=4">

<style>/* مساحة الصفحة الداخلية */
.page { padding: 30px; }
/* حاوية الجدول لتوسيطه وتحديد عرضه */
.ratings-wrap { border:0.5px solid #c5c3c3; max-width: 1180px; margin: 0 auto; border-radius:18px ;}
/* كرت الجدول (الخلفية + الحواف + الظل) */
.ratings-card { background: #FFFFFF; border: 1px solid #E8E8E8; border-radius: 18px; box-shadow: 0 2px 8px rgba(0,0,0,0.04); overflow: hidden; }
/* الجدول نفسه */
                            ...
                            <?php if ($result && $result->num_rows > 0): ?>
                                <?php while ($row = $result->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td class="req-code">
                                            <?php echo "#UA" . str_pad($row['request_id'], 4, "0", STR_PAD_LEFT); ?>
                                        </td>
