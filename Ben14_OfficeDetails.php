...
<style>
/* الصفحة */
.page{ padding:10px 30px; font-family:"Noto Kufi Arabic",sans-serif; }

/* صف الرجوع */
.backrow{ width:90%; margin:10px auto 18px; display:flex; justify-content:flex-end; }

/* تغليف الرجوع */
.backwrap{ display:flex; align-items:center; }

/* بطاقة المكتب */
.dbox{ width:90%; margin:0 auto 20px; background:#fff; border:1px solid #e4e4e4; border-radius:10px; padding:18px; box-shadow:0 2px 8px rgba(0,0,0,0.04); }

/* اسم المكتب */
.ttl{ font-size:20px; font-weight:700; color:#5a2d82; text-align:right; margin-bottom:10px; }

/* وصف المكتب */
.desc{ font-size:14px; color:#555; line-height:2; margin-bottom:14px; }

/* عنوان الدول */
.sttl{ font-size:15px; font-weight:700; color:#444; margin-bottom:10px; }

/* صندوق الدول */
.cbox{ display:flex; flex-wrap:wrap; gap:8px; margin-bottom:18px; }

/* الدولة */
.ctag{ background:#eadcf6; color:#5a2d82; padding:5px 10px; border-radius:14px; font-size:12px; font-weight:600; }

/* صف المحتوى */
.midrow{ display:flex; gap:14px; margin-bottom:14px; }

/* عمود الأزرار */
.actcol{ flex:1; display:flex; flex-direction:column; gap:8px; }

/* صندوق الرسوم */
.feebox{ flex:1; background:#f4f6f7; border:1px solid #dcdcdc; border-radius:6px; padding:14px; }

/* عنوان الرسوم */
.feettl{ font-size:14px; font-weight:700; color:#555; text-align:center; margin-bottom:16px; }

/* قريد الرسوم */
.feegrid{ display:grid; grid-template-columns:33% 33% 33%; text-align:center; }

/* عنصر الرسوم */
.feeitem{ font-size:14px; color:#4b2a63; line-height:2; }

/* اسم البرنامج */
.fname{ display:block; font-size:16px; font-weight:700; color:#555; margin-bottom:6px; }

/* سعر البرنامج */
.fprice{ display:block; font-size:16px; font-weight:700; color:#4b2a63; }

/* الأزرار */
.btnlight,.btndark{ width:100%; height:40px; border:none; border-radius:6px; font-family:"Noto Kufi Arabic",sans-serif; font-size:15px; font-weight:600; cursor:pointer; }

/* زر التواصل */
.btnlight{ background:#d7bce4; color:#fff; height:67px; }

/* زر التقديم */
.btndark{ background:#4b2a63; color:#fff; height:67px; }

/* قسم التقييمات */
.rsec{ width:90%; margin:0 auto; }

/* عنوان التقييمات */
.rttl{ font-size:15px; font-weight:700; color:#4b2a63; margin-bottom:10px; }

/* بطاقة التقييم */
.rcard{ background:#fff; border:1px solid #dcdcdc; border-radius:4px; padding:10px; margin-bottom:10px; display:flex; justify-content:space-between; gap:12px; }

/* نص التقييم */
.rtxt{ flex:1; }

/* التاريخ */
.rdate{ font-size:12px; color:#777; margin-bottom:6px; }

/* اسم المستفيد */
.rname{ font-size:14px; font-weight:700; color:#555; margin-bottom:6px; }

/* التعليق */
.rcom{ font-size:13px; color:#666; line-height:1.8; }

/* صورة التقييم */
.rimg{ width:34px; height:34px; border-radius:4px; object-fit:cover; border:1px solid #cfcfcf; }

/* لا توجد تقييمات */
.norate{ background:#fff; border:1px solid #ddd; border-radius:6px; padding:14px; text-align:center; color:#666; }
</style>
</head>
...
<!-- التاريخ -->
<div class="rdate">
<?php echo date("d-m-Y", strtotime($rate['rating_date'])); ?>
</div>
