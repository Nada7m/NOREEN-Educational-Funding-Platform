...
$sqlTotal = "SELECT COUNT(*) AS total_requests FROM admission_request
...
// جلب عدد الطلبات قيد المعالجة
$sqlProcessing = "SELECT COUNT(*) AS processing_requests  FROM admission_request
     WHERE office_id = $office_id
...
$sqlRequests = "SELECT  ar.request_id, ar.request_status, ar.Result_status, ar.payment_status,
                ar.Submit_date,  b.f_name,  b.l_name FROM admission_request ar
                INNER JOIN beneficiary b ON ar.bnf_id = b.bnf_id WHERE ar.office_id = $office_id
