...
/* توزيع بطاقات المنح داخل الصفحة */
...
<div class="layout">
    ...
    <div class="main-content">
        ...
        <header class="header">
            ...
            <div class="page-heading">
                ...
                <div class="page-description">
                    صفحة استعراض وتقديم الطلبات على المنح المتاحة
                </div>
        ...
        <div class="page">
            ...
            <!-- فلترة المنح حسب المجال -->
            <form method="POST" class="filter-container">

                <div class="filter-label">
                    تصفية المنح حسب المجال الرئيسي:
                </div>

                <!-- تنفيذ الفلترة مباشرة عند تغيير الاختيار -->
                <select name="sch_field" class="filter-select" onchange="this.form.submit()">
                    ...
                    /* عرض الخيارات داخل القائمة */
                    foreach($fields as $f) {

                        /** الحفاظ على المجال المختار ظاهرًا بعد تحديث الصفحة **/
            ...
            <div class="scholarships-grid">
                ...
                /** إضافة شرط الفلترة حسب المجال المختار **/
                if (!empty($selected_field)) {

                    $q .= "
                        AND s.sch_field = '".$conn->real_escape_string($selected_field)."'
                    ";
                }

                /* تنفيذ استعلام جلب المنح */
                $res = $conn->query($q);

                /* عرض بطاقات المنح */
                while($row = $res->fetch_assoc()):

                    /* تحديد اسم الجهة المقدمة للمنحة */
                ...
                <div class="s-card">
                    ...
                    <div class="s-content">
                        ...
                        <div class="s-item">
                            ...
                            <div class="s-val">
                                <?php echo htmlspecialchars($row['sch_field']); ?>
                            </div>
                    ...
                    <div class="s-item s-deadline">
                        ...
                        <div class="s-val">
                            <?php echo date("Y-m-d", strtotime($row['app_deadline'])); ?>
                        </div>

                    </div>

                    <!-- الانتقال إلى صفحة تفاصيل المنحة -->
